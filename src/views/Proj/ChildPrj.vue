  ...
  <div>
      ...
      <div>
        <el-card style="width: 20%;text-align: center;float: left;margin-right: 20px" class="box-card">
          ...
          <div v-if="title_1 === '在线'&&remoteInfo.type==='repeater'" style="font-size: 14px"><img style="vertical-align: middle;" :src="'/static/'+remoteInfo.BatteryImage" />
...
export default {
  ...
  methods :{
    ...
    sz() {
      ...
      this.$api.post('prj/clientSettings', {flag:'get'}, r => {
    ...
    zr() {
      ...
      this.$api.post('prj/clientSettings', p, r => {
        this.$message({
          type: 'warning',
