      ...
      <el-col :xs="24" :sm="24" :lg="24">
        <div>
          <el-table :data="tableData" stripe style="width: 100%">
            ...
            <el-table-column prop="ExecuteUnit" label="建设单位" min-width="100" max-width="20"></el-table-column>
...
export default {
    ...
    methods: {
      loadData() {
        ...
        this.$api.post('prj/completedPrj', a).then( r => {
          v.tableData = r.rows
          v.total = r.total
        })
      },
