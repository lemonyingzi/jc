  ...
  <div>
    ...
    <el-row :gutter="40">
      <el-col :xs="24" :sm="24" :lg="24">
        <div>
          <el-table :data="tableData" stripe style="width: 100%" @row-dblclick="rowDblClick">
            ...
            <el-table-column prop="mpn" label="测点编号" min-width="100"></el-table-column>
            ...
            <el-table-column prop="signal" label="信号强度" max-width="20"> <!-- :formatter="img" -->
